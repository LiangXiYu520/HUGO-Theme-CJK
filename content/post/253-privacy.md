...
categories: ["站務"]
tags: ["coding"]
description: '我有必要將本站所有涉及您隱私的情況完全透明展示給您。'
vertical: false
---
...
無意間發現 [webbkoll](https://webbkoll.dataskydd.net/en)，便按照指引補了一下安全漏洞。

我託管於 Netlify，便在根目錄下新建 `_headers` 純文本文件：
...
SRI, Subresource Integrity 是一個核對清單，將遠程加載的 sha 値與你設置的進行對比，相同的就可以加載。

## 速度

- 用了 [InstantPage](https://instant.page/) 腳本，實現站內預加載
- 生成時用了 `hugo --minify`，把 css、js 壓縮到最小
- js 放在最後，使用延遲加載、異步加載
- 無框架；無多餘 js
