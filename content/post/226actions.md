---
author: ["柯棋瀚"]
title: "Deploy Hugo Site Periodically to Netlify by GitHub Actions"
date: 2020-04-20
lastmod: 2020-04-20
categories: ["站務"]
tags: ["coding"]
url: /226
markdown: 'https://github.com/kujihhoe/blogflex/blob/master/content/post/226actions.md'
...
現在加上了隨機推薦後（主葉分類；各文章下面的隨機推薦），我們要運行定時生成任務，以定時生成隨機推薦，有兩種方法：
...
另外，關於定時任務的設置 `- cron`，可以用這個網址 https://crontab.guru/ 來測試。我設置的是每小時生成一次，就是 `- cron: '0 */1 * * *'`。之前不知道，設成了 `- cron: '* */1 * * *'`，那就是每時每刻都在生成！幸虧發現得早。
