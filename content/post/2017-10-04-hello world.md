...
發現一箇問題，有圖片的文章</n>1</n>基本上要刷新一次，目錄纔會正常顯示，要不然拖到後半部分目錄以爲文章已完，就跑上去了。</n>2</n>還沒瀏覽到下箇標題，目錄就已經跳到下箇標題了，我猜是沒把圖片的空間計算進去。无奈不知如何解決。
...
</n>1</n>新建一箇一模一樣的倉庫，用來存放新的域名。</n>2</n>添加 301 重定向。</n>3</n>其他域名郵箱、搜索引擎的設置。
