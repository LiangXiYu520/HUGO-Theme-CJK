...
categories: ["史"]
url: /net/history-5
description: '「他所谓的实证不过是把材料放在一起，然后写一篇文章，把材料放成一个比较平滑的、比较容易读的样式，用一种文章的方式发表出来，所以它是一种文本整理工作，这个跟实证不是一回事。」目錄：仇鹿鳴專訪；學術生活；教育；存目。'
vertical: false
---

## 封面：《[经验与互联网丨陈嘉映与项飙对话实录](https://mp.weixin.qq.com/s/aNUWWXsh3DaLUUljmUdL1A)》
