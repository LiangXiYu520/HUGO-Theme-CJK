...
categories: ["史"]
url: /net/history-5
description: '本期專題有兩篇文章，其一爲陳嘉映與項飆的對談，其二爲仇鹿鳴的訪談，從社會大眾與歷史學學術的角度談談互聯網對我們的改變。「他所谓的实证不过是把材料放在一起，然后写一篇文章，把材料放成一个比较平滑的、比较容易读的样式，用一种文章的方式发表出来，所以它是一种文本整理工作，这个跟实证不是一回事。」【目錄】仇鹿鳴專訪；學術生活；教育；存目。'
vertical: false
